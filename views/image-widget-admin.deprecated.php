...
<br /><small><?php _e('This image should be 445w x 180h (px).')?></small>
	<?php
    ...
    <div id="display-<?php echo $this->get_field_id('image'); ?>"><?php echo $this->image_widget_get_image_html($instance); ?></div>
    <br clear="all" />
...
<p><label for="<?php echo $this->get_field_id('align'); ?>"><?php _e('Align', 'image_widget'); ?>:</label>
	<select class="widefat" name="<?php echo $this->get_field_name('align'); ?>" id="<?php echo $this->get_field_id('align'); ?>" onchange="imageWidget.changeImgAlign('<?php echo $this->id; ?>')">
