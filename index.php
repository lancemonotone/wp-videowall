<?php
/**
 * Williams Meerkat Videowall
 * 
 * @package Williams_Meerkat_Videowall
 * @author Williams College Web Team
 * @version 1.0.0
 */
/*
...
class Meerkat_Videowall {
    var $namespace = 'meerkat-videowall';
    var $friendly_name = 'Williams Meerkat Videowall';
    var $version = "1.0.0";
     ...
     * 
     * @uses add_action()
     * @uses Meerkat_Videowall::wp_register_scripts()
     * @uses Meerkat_Videowall::wp_register_styles()
     */
    function __construct() {
         ...
         */
        //load_theme_textdomain( $this->namespace, MEERKATVIDEOWALL_DIRNAME . '/languages' );
	...
	// Add post type and custom fields
     ...
     * 
     * @uses Meerkat_Videowall::sanitize()
     * @uses wp_redirect()
    ...
    function admin_options_page() {
        ...
        include( MEERKATVIDEOWALL_DIRNAME . "/views/view-options.php" );
    }
    ...
    static function instance() {
        ...
        if( !isset( $Meerkat_Videowall ) ) $Meerkat_Videowall = new Meerkat_Videowall();
	...
	function plugin_action_links( $links, $file ) {
		if( $file == plugin_basename( MEERKATVIDEOWALL_DIRNAME . '/' . basename( __FILE__ ) ) ) {
            $old_links = $links;
            $new_links = array(
     ...
     * form processor.
     * 
     * @uses Meerkat_Videowall::_admin_options_update()
     */
    function route() {
    ...
    /**
     * Register featured_story custom post type and ACF custom fields
     *
    ...
    function wp_register_scripts() {
        // Admin JavaScript
        wp_register_script( "{$this->namespace}-admin", MEERKATVIDEOWALL_URLPATH . "/js/admin.js", array( 'jquery' ), $this->version, true );
    }
    ...
    function wp_register_styles() {
        // Admin Stylesheet
        wp_register_style( "{$this->namespace}-admin", MEERKATVIDEOWALL_URLPATH . "/css/admin.css", array(), $this->version, 'screen' );
    }
    
}
if( !isset( $Meerkat_Videowall ) ) {
	Meerkat_Videowall::instance();
}

register_activation_hook( __FILE__, array( 'Meerkat_Videowall', 'activate' ) );
register_deactivation_hook( __FILE__, array( 'Meerkat_Videowall', 'deactivate' ) );